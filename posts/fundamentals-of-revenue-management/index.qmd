...
While airlines 
This setup is not exclusive to airlines of course: Hotels? Events, such as Bad Bunny concerts? Car rentals? Absolutely, there's a limited number of rooms/seats/cars and once the day/night is over, no more revenue can be extracted. Online marketplaces like Walmart or Amazon? Not exactly. Razors are easy to replenish and they don't expire. While Amazon is known for sophisticated pricing research, the perishable-capacity logic at the heart of RM isn't central to their business the way it is for airlines.
...
There are more sophisticated unconstraining methods out there — projection detruncation and EM (expectation maximization) are common [see @weatherford2002 for a comparison] — but the key idea is the same. After applying unconstraining, the airline determines that the true demand distribution is $N(122, 25)$ for promo and $N(30, 7)$ for flex. Now — how do we use this to calculate booking limits?
...
- **We completely ignored competition.** We completely ignored 

We'll tackle these and other assumptions in future posts. In the meantime, let us know what you think and what RM topics you'd like to see covered next!
